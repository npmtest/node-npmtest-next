...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-next/node_modules/next/dist/server/build/root-module-relative-path.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header high">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-next/node_modules/next/dist/server/build/root-module-relative-path.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-next/node_modules/next/dist/server/build/</a> &#187; root-module-relative-path.js</div>
</div>
<div class="body">
...
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (relativeStartIndex === -1) {
